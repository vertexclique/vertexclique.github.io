...
| :--------------------------------------------- | :------------------------------------------------------- | :------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------- |
| **Jet-Engine/ScramVM** | Morsel-driven query engine with bytecode compilation | 77.6 ms | No dataset specific optimization, allocation optimization, and reading optimization. Generic craft.
